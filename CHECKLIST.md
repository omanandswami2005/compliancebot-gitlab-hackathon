...
- [x] Create `agents/compliance-scanner.yaml` with official AI Catalog format
...
- [x] Create `agents/compliance-mapper.yaml` with official AI Catalog format
  - [x] Set `public: true` for AI Catalog publication
...
- [x] Create `agents/evidence-collector.yaml` with official AI Catalog format
  - [x] Set `public: true` for AI Catalog publication
...
- [x] Create `agents/compliance-reporter.yaml` with official AI Catalog format
  - [x] Set `public: true` for AI Catalog publication
...
- [x] Create `flows/compliance-flow.yaml` with official AI Catalog format
  - [x] Set `public: true` for AI Catalog publication
